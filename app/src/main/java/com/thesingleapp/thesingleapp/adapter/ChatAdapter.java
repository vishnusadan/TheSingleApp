...
public class  ChatAdapter extends RecyclerView.Adapter {
    ...
    public int unicode = 0x1F60A;

    public ChatAdapter(Context context, List<Chat_model> messageList) {
        mContext = context;
    ...
    public int getItemViewType(int position) {
        ...
        Chat_model message = mMessageList.get(position);
    ...
    private class ReceivedMessageHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Chat_model message) {
            ...
            nameText.setText(message.getFirstName());

            // Insert the profile image from the URL into the ImageView.
            Glide.with(mContext)
                    .load(Api.IP +"media/"+message.getProfilePic())
