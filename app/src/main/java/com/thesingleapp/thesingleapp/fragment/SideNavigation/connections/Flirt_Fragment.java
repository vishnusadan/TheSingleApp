...
public class Flirt_Fragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View flirt =inflater.inflate(R.layout.fragment_flirt,container,false);

        tab1 = flirt.findViewById(R.id.tab1);
        tab2 = flirt.findViewById(R.id.tab2);
        tab1.setOnClickListener(this);
        tab2.setOnClickListener(this);

        //To show default fragment
        replaceFragment(new FlirtedMe_Fragment());
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tab2:
                ...
                replaceFragment(new IHadFlirt_Fragment());
    ...
    private void replaceFragment(Fragment fragment) {
        ...
        fragTrans.replace(R.id.linearflirt, fragment, "MY_FRAGMENT");
