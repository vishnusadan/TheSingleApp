...
public class Termsandcondition extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View privacyandpolicy = inflater.inflate(R.layout.fragment_termsndcondition, container, false);
    ...
    public void getTermsndcondition(){

        //start shimmer effect
        sh1.startShimmer();

        // Creating string request with post method.
        stringRequest = new StringRequest(Request.Method.GET, Api.TERMSANDCONDITION,
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        try {
                            ...
                            if(aboutus_cont!=null && aboutus_cont.length()>0) {
                                ...
                                CommonMethod.showToast(getActivity(),"No Terms and Conditions Still now Published");
